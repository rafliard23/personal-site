---
title: "Memilih Peripheral Komputer - Mouse"
...
{{< figure
    src="https://media.rafliard.net/content/posts/2023/11/14_PeriMouse/usbm_ergonomicSizes.webp"
    alt="Logitech Family Mice"
    caption="Beberapa jenis mouse dengan ukuran serta genggaman yang berbeda buatan Logitech."
    class="grid-w50 md:grid-w33 xl:grid-w50"
    >}}
...
{{< figure
    src="https://i.rtings.com/assets/pages/14CTjJpJ/best-wired-mouse2-medium.jpg"
    caption="Mouse Wired dan Wireles oleh [Duncan MacRae, rtings.com (2023)](https://www.rtings.com/mouse/reviews/best/by-type/wired)"
    class="grid-w70 md:grid-w50"
    >}}
...
{{< figure
    src="https://media.rafliard.net/content/posts/2023/11/14_PeriMouse/usbm_NYKS80.webp"
    class="grid-w70 md:grid-w33 xl:grid-w40"
    >}}
...
{{< figure
    src="https://media.rafliard.net/content/posts/2023/11/14_PeriMouse/usbm_Datasheet.webp"
    alt="Mouse Sensor"
