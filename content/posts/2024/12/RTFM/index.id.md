---
title: "RTFM! | Membudayakan membaca informasi"
date: 2024-12-19T18:50:08+07:00
lastmod:
tags: []
categories: []
slug:
...
{{< figure
    src="https://upload.wikimedia.org/wikipedia/commons/7/7a/RTFM_%2812034282963%29.jpg"
    class="xl:grid-w50"
    caption="Tumpukan buku _dengan ajakan untuk membaca_. [Sumber:Paul Cross](https://commons.wikimedia.org/wiki/File:RTFM_(12034282963).jpg) dengan lisensi [CCA-2.0 Generic](https://creativecommons.org/licenses/by/2.0/deed.en)"
    >}}

Membaca manual book, datasheet, ataupun petunjuk merupakan hal _biasa_ bagi segelintir orang, namun efeknya begitu besar jika dibiasakan terutama bagi kita yang dari latar belakang engineer, teknik, atau akademisi. Mengetahui petunjuk pengunaan alat atau mengidentifikasi komponen yang kita gunakan adalah separuh tanggungan yang perlu kita penuhi agar pekerjaan yang kita lakukan bisa beres, sisanya adalah usaha yang kita lakukan dalam mencapai target atau tujuan penggunaan alat/komponen yang kita pilih...

## (Pembiasaan) Membaca Petunjuk untuk Mencapai Tujuan

{{< figure
    src="https://media.rafliard.net/content/posts/2024/12/19_RTFM/src/rtfm_datasheet_irfz44n.webp"
    class="xl:grid-w50"
    caption="Datasheet MOSFET IRFZ44N"
    >}}

Membaca manual book, buku petunjuk, dokumentasi project merupakan hal esensial bagi developer atau engineer ketika menghadapai hal yang asing. Membaca adalah salah satu metode untuk menggali informasi yang universal tanpa memandang bidang. Secara harfiah, membaca sendiri bisa bermakna "menangkap" informasi dengan menggunakan indra manusia yang menghasilkan ide, analisa, pertimbangan, dan pemecahan masalah terhadap konflik atau problem saat itu. Membaca mampu memangkas waktu kita dalam proses _transfer knowledge_ karena kita tidak perlu orang lain untuk menangkap informasi yang disodorkan atau dibutuhkan.
...
## Esensi Membaca Petunjuk

Esensi membaca petunjuk mendorong seseorang lebih mandiri dan manfaat yang tak ternilai, beberapa poin seperti:  
### Kemandirian

Dalam KBBI, mandiri _/man·di·ri/ a_ dalam keadaan dapat berdiri sendiri; tidak bergantung pada orang lain. dan _kemandirian /ke·man·di·ri·an/ n_ hal atau keadaan dapat berdiri sendiri tanpa bergantung pada orang lain.
