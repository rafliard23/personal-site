...
{{< figure
    src="https://media.rafliard.net/content/posts/2024/09/13_updateS80/repS80-board_fix.webp"
    alt="Attempt to fix"
    caption="Fix jumper menggunakan kawat."
    class="xl:grid-w50"
    >}}
...
{{< gallery >}}
  <img src="https://media.rafliard.net/content/posts/2024/09/13_updateS80/repS80-board_test_no_battery.webp" class="grid-w33 md:grid-w15" />
  <img src="https://media.rafliard.net/content/posts/2024/09/13_updateS80/repS80-worked.webp" class="grid-w33 md:grid-w15" />
  <img src="https://media.rafliard.net/content/posts/2024/09/13_updateS80/repS80-test_battery.webp" class="grid-w33 xl:grid-w15" />
{{< /gallery >}}
