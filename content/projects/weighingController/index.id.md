...
{{< figure
    src="https://media.rafliard.net/content/projects/weighingController/awc_system_hardwares.webp"
...
{{< figure
    src="https://media.rafliard.net/content/projects/weighingController/awc_system_diagram.webp"
    alt="Komponen Automatic Weighing Controller"
...
{{< figure
    src="https://media.rafliard.net/content/projects/weighingController/program-flowchart.webp"
...
{{< figure
    src="https://media.rafliard.net/content/projects/weighingController/awc_system_electric.webp"
    alt=""
    caption="Hasil pengerjaan desain PCB dan Elektrik"
    class="xl:grid-w66"
    >}}

{{< github repo="rafliard23/kb-weighing-control-hardware" showThumbnail=false >}}
